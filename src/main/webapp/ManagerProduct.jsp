			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<c:forEach items="" var="o">
						...
						<%
						ArrayList<Product> ds = (ArrayList<Product>) request.getAttribute("listcid");

						if (ds != null) {
							for (Product ledit : ds) {
						%>
						...
						<tr>
							...
							<td><%=ledit.getId()%></td>
							<td><b><%=ledit.getName()%></b></td>
							<td><img src="<%=ledit.getImage()%>"></td>
							<td><%=ledit.getPrice()%></td>
							<td><a href="LoadControl?editid=<%=ledit.getId()%>" class="edit"
								data-toggle="modal"><i class="material-icons"
									data-toggle="tooltip" title="Edit">&#xE254;</i></a> <a
								href="DeleteControl?pid=<%=ledit.getId()%>" class="delete"
								data-toggle="modal"><i class="material-icons"
